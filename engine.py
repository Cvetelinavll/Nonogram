"""
 _   _                                                ____                      
| \ | | ___  _ __   ___   __ _ _ __ __ _ _ __ ___    / ___| __ _ _ __ ___   ___ 
|  \| |/ _ \| '_ \ / _ \ / _` | '__/ _` | '_ ` _ \  | |  _ / _` | '_ ` _ \ / _ \
| |\  | (_) | | | | (_) | (_| | | | (_| | | | | | | | |_| | (_| | | | | | |  __/
|_| \_|\___/|_| |_|\___/ \__, |_|  \__,_|_| |_| |_|  \____|\__,_|_| |_| |_|\___|
                         |___/                                                  
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                if p_grid[row_clicked][col_clicked]==0:
                    p_grid[row_clicked][col_clicked] = 1
                
                else: p_grid[row_clicked][col_clicked] = 0

                #CHECK AND CLOSE IF ALL values are the same as the generated grid (tobeChanged)
